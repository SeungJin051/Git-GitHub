...
![git-reset-vs-git-revert](https://user-images.githubusercontent.com/83889135/194001933-8cc96054-0b46-4346-8704-e86afe2b60a2.jpeg)
 ...
 ![git-branches-merge](https://user-images.githubusercontent.com/83889135/193998253-cc7aa72b-8248-40e4-81ba-c2fa328ae0c6.png)
  + 변경 사항을 병합할 준비가 될 때까지 기본 코드 베이스에 영향을 주지 않고 새로운 기능, 버그 수정 또는 실험 작업을 할 수 있습니다.
 ...
 ## Branch 사용법 
  1. 새 브랜치 만들기: 새 브랜치를 만들려면 작업하려는 리포지토리에서 "브랜치" 드롭다운을 클릭합니다. 새 브랜치에 해당 브랜치에서 수행할 작업을 설명하는 이름을 지정합니다.
  2. 새 브랜치로 전환: 새 브랜치를 만든 후에는 해당 브랜치로 전환해야 합니다. 지점 이름을 클릭하고 새 지점을 선택하면 됩니다.
  3. 브랜치 변경: 이제 새 브랜치에 있으므로 코드베이스 변경을 시작할 수 있습니다. 여기에는 새로운 기능 추가 또는 버그 수정이 포함될 수 있습니다. 원하는 만큼 변경하고 진행하면서 커밋할 수 있습니다.
  4. 브랜치로 변경 사항 푸시: 변경 사항을 적용하고 커밋한 후에는 브랜치로 푸시해야 합니다. 이렇게 하면 변경 사항이 원격 저장소로 전송되고 팀의 다른 사람들이 사용할 수 있습니다.
  5. 풀 요청 열기: 팀에서 작업하는 경우 변경 사항에 대한 풀 요청을 열어야 합니다. 이는 기본적으로 다른 팀원이 변경 사항을 검토하고 이를 기본 코드베이스에 병합하도록 요청하는 것입니다. 풀 리퀘스트를 열려면 브랜치로 이동하여 "새 풀 리퀘스트" 버튼을 클릭하세요.
  6. 변경 사항 검토 및 병합: 풀 요청을 열면 다른 팀원이 변경 사항을 검토하고 피드백을 제공할 수 있습니다. 모든 사람이 변경 사항에 만족한다면 "풀 요청 병합" 버튼을 클릭하여 풀 요청을 기본 코드베이스에 병합할 수 있습니다.
  7. 브랜치 삭제: 변경 사항이 기본 코드베이스에 병합되면 브랜치를 삭제하여 깔끔하게 유지할 수 있습니다. 이렇게 하려면 지점으로 이동하여 "지점 삭제" 버튼을 클릭합니다.
